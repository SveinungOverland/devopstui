...
| Need            | Call                                                                                                                                                   | Notes                                                                                                                                                                                                                                                                        |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Auth            | `azuredevops.NewPatConnection(orgURL, pat)`                                                                                                            | PAT from `AZURE_DEVOPS_EXT_PAT` env, config, or keychain later. Scopes needed: _Work Items (Read & Write)_, _Project & Team (Read)_.                                                                                                                                         |
...
and its children grouped by state (as a list, or a kanban with `f`), with a preview of the
highlighted child or related item, and child creation and state moves from inside it.
...
| Should closed items show in the sprint tree?                 | **Reversed (#30):** shown by default, `c` hides them. The Iteration and Team filters already bound how many items load, so hiding by default was no longer earning its keep.                                                                     |
